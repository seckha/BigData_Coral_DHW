...
# I should be able to make a loop to do this, but can't get it right
...
names(extracts_list) <- c("ex_macgillivray", "ex_boulder", "ex_13124S", "ex_agincourt", "ex_feather", "ex_rib", "ex_19138S","ex_chinaman", "ex_broomfield", "ex_credlin")
