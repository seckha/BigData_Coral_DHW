...
ggsave(p, filename = here("Plots/dhw_ts_all_locations.png"), height = 45, width = 30, units = "cm", scale = 0.7)
...
ggsave(p, filename = here("Plots/cpue_ts_all_locations.png"), height = 45, width = 30, units = "cm", scale = 0.7)
```
